...
public class GameState
{
	...
	public byte PlayPiece(int column)
	{
		...
		if (!winStreakRecorded)
		{
			var result = CheckForWin();
			if (result == WinState.Player1_Wins)
			{
				Player1WinStreak++;
				Player2WinStreak = 0;
				winStreakRecorded = true;
			}
			else if (result == WinState.Player2_Wins)
			{
				Player2WinStreak++;
				Player1WinStreak = 0;
				winStreakRecorded = true;
	...
	/// <summary>
	/// Number of consecutive games Player 1 has won in a row
	/// </summary>
	public int Player1WinStreak { get; private set; }

	/// <summary>
	/// Number of consecutive games Player 2 has won in a row
	/// </summary>
	public int Player2WinStreak { get; private set; }

	private bool winStreakRecorded = false;
